...
static void PCD_dump_fault_info( exception_t *exception )
{
    ...
    i = snprintf( buffer, PCD_ERRLOG_BUF_SIZE - 1, "\nMIPS registers:\n\n"
				...
				(uint32_t)exception->uc_mctx.gregs[0],
				(uint32_t)exception->uc_mctx.gregs[1],
				(uint32_t)exception->uc_mctx.gregs[2],
				(uint32_t)exception->uc_mctx.gregs[3],
				(uint32_t)exception->uc_mctx.gregs[4],
				(uint32_t)exception->uc_mctx.gregs[5],
				(uint32_t)exception->uc_mctx.gregs[6],
				(uint32_t)exception->uc_mctx.gregs[7],
				(uint32_t)exception->uc_mctx.gregs[8],
				(uint32_t)exception->uc_mctx.gregs[9],
				(uint32_t)exception->uc_mctx.gregs[10],
				(uint32_t)exception->uc_mctx.gregs[11],
				(uint32_t)exception->uc_mctx.gregs[12],
				(uint32_t)exception->uc_mctx.gregs[13],
				(uint32_t)exception->uc_mctx.gregs[14],
				(uint32_t)exception->uc_mctx.gregs[15],
				(uint32_t)exception->uc_mctx.gregs[16],
				(uint32_t)exception->uc_mctx.gregs[17],
				(uint32_t)exception->uc_mctx.gregs[18],
				(uint32_t)exception->uc_mctx.gregs[19],
				(uint32_t)exception->uc_mctx.gregs[20],
				(uint32_t)exception->uc_mctx.gregs[21],
				(uint32_t)exception->uc_mctx.gregs[22],
				(uint32_t)exception->uc_mctx.gregs[23],
				(uint32_t)exception->uc_mctx.gregs[24],
				(uint32_t)exception->uc_mctx.gregs[25],
				(uint32_t)exception->uc_mctx.gregs[26],
				(uint32_t)exception->uc_mctx.gregs[27],
				(uint32_t)exception->uc_mctx.gregs[28],
				(uint32_t)exception->uc_mctx.gregs[29],
				(uint32_t)exception->uc_mctx.gregs[30],
				(uint32_t)exception->uc_mctx.gregs[31]);
    ...
    i = snprintf( buffer, PCD_ERRLOG_BUF_SIZE - 1, "\nx64 registers:\n\n"
                  ...
                  "OLDMASK=0x%016lx\n"
                  "CR2=0x%016lx\n",
                  (uint64_t)exception->uc_mcontext.gregs[REG_R8],
                  (uint64_t)exception->uc_mcontext.gregs[REG_R9],
                  (uint64_t)exception->uc_mcontext.gregs[REG_R10],
                  (uint64_t)exception->uc_mcontext.gregs[REG_R11],
                  (uint64_t)exception->uc_mcontext.gregs[REG_R12],
                  (uint64_t)exception->uc_mcontext.gregs[REG_R13],
                  (uint64_t)exception->uc_mcontext.gregs[REG_R14],
                  (uint64_t)exception->uc_mcontext.gregs[REG_R15],
                  (uint64_t)exception->uc_mcontext.gregs[REG_RDI],
                  (uint64_t)exception->uc_mcontext.gregs[REG_RSI],
                  (uint64_t)exception->uc_mcontext.gregs[REG_RBP],
                  (uint64_t)exception->uc_mcontext.gregs[REG_RBX],
                  (uint64_t)exception->uc_mcontext.gregs[REG_RDX],
                  (uint64_t)exception->uc_mcontext.gregs[REG_RAX],
                  (uint64_t)exception->uc_mcontext.gregs[REG_RCX],
                  (uint64_t)exception->uc_mcontext.gregs[REG_RSP],
                  (uint64_t)exception->uc_mcontext.gregs[REG_RIP],
                  (uint64_t)exception->uc_mcontext.gregs[REG_EFL],
                  (uint64_t)exception->uc_mcontext.gregs[REG_CSGSFS],
                  (uint64_t)exception->uc_mcontext.gregs[REG_ERR],
                  (uint64_t)exception->uc_mcontext.gregs[REG_TRAPNO],
                  (uint64_t)exception->uc_mcontext.gregs[REG_OLDMASK],
                  (uint64_t)exception->uc_mcontext.gregs[REG_CR2]);
...
void PCD_exception_listen( void )
{
    ...
    else
    {
        ...
        uint32_t remainingBytes = sizeof( exception_t );
